...
namespace Fashion.Common.DB
{
	public class BaseDBConfig
	{
		private static string sqliteConnection = AppSettingsHelper.app(new string[] { "AppSettings", "Sqlite", "SqliteConnection" });
		private static bool isSqliteEnabled = (AppSettingsHelper.app(new string[] { "AppSettings", "Sqlite", "Enabled" })).ObjToBool();
		...
		private static string InitConn()
		{
			...
			{
				return "server=.;uid=sa;pwd=123456;database=Fashion";
			}
