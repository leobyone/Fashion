...
namespace Fashion.Common
{
	...
	{
		private static string Audience_Secret = AppSettingsHelper.app(new string[] { "Audience", "Secret" });
		private static string Audience_Secret_File = AppSettingsHelper.app(new string[] { "Audience", "SecretFile" });
