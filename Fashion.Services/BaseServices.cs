...
namespace Fashion.Services
{
	...
	public class BaseServices<TEntity> : IBaseServices<TEntity> where TEntity : class, new()
	{
		...
		{
			return await baseRepository.Update(entity, lstColumns, lstIgnoreColumns, strWhere);
		}
		...
		{
			return await baseRepository.QueryMuch(joinExpression, selectExpression, whereLambda);
		}
	}
}
